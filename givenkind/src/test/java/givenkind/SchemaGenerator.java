...
public class SchemaGenerator {
    ...
    public static void main(String[] args) throws Exception {
        final String packageName = "org.givenkind.model";
        SchemaGenerator gen = new SchemaGenerator(packageName);
        final String directory = "/home/force/generatedSqlSchema";
	...
	private void generate(Dialect dialect, String directory) {
        ...
        export.setDelimiter(";");
        export.setOutputFile(new File(directory, "ddl_" + dialect.name().toLowerCase() + ".sql").getAbsolutePath());
