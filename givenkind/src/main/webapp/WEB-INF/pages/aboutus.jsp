...
<div id='mainContainer' class='container-fluid'>
	<div id='gnk-aboutus' class='row'>
		<div class='col-sm-offset-2 col-sm-8'>
			...
			<p>giveNkind is a Chicago-based nonprofit organization dedicated to re-imagining giving to maximize the impact of a 
			...
			<h2>Our Vision</h2>
			<p>The vision of the giveNkind organization is to support nonprofits in bettering the world.<br></p>
			...
			<h2>The giveNkind Story</h2>
			<p>After founding the Atlanta chapter of Becca’s Closet in 2009, giveNkind founder Emily Petway quickly discovered that, in order 
			...
			<h2>Emily Petway, President</h2>
			<img src="<c:url value="/img/emily.jpg"/>"/>
			<p>Emily Petway is the founder and president of giveNkind. Petway is an active leader in the nonprofit community and, most recently, founded and managed the Atlanta 
			...
			<h2>Natalie Keable, Vice President</h2>
			<img src="<c:url value="/img/natalie.jpg"/>"/>
			<p>Natalie Keable is a Senior Consultant at Clerestory Consulting, LLC; a consulting firm that specializes in change management. Prior to working at Clerestory, 
			...
			<h2>Patrick Swartzer, Treasurer</h2>
			<img src="<c:url value="/img/patrick.png"/>"/>
			<p> Patrick currently works as an analyst at The Intercontinental Exchange in the Market Regulation Department. In the past, he clerked at law firms specializing 
			...
			<h2>Pranav Parekh</h2>
			<p>As Director of Information Technology, Pranav oversees and manages the technical, network and application framework of the company.  He directs the company’s 
			...
			<h2>Jen Greco</h2>
			<img src="<c:url value="/img/JenG.jpg"/>"/>
			<p>Jen Greco has over 15 years of marketing and design experience. She is currently a graphic designer working with clients in the entertainment, food and housewares 
			...
			<h2>Alan Cruz</h2>
			<img src="<c:url value="/img/alan.jpg"/>"/>
			<p>Alan Cruz is a Texas native who has been a software developer/project manager for the DoD for over 8 years. He is received his bachelors degree in computer sciences 
			...
			<h2>Benjamin Somberg</h2>
			<img src="<c:url value="/img/ben.jpg"/>"/>
			<p>Benjamin L. Somberg received his bachelor’s degree from Duke University and a Ph.D. in experimental psychology from the University of Missouri—Columbia.  For over 
