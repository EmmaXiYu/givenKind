		...
		<div class='row'>
			<div class='col-sm-12'>
				...
				<table class='table'>
					<thead>
						<tr>
							<th class='col-sm-2'>Item Name (Your fullfilled Wishlist)</th>
							<th class='col-sm-2'>Item Name (Your received Donations)</th>
					...
					<tbody>
						...
						<c:forEach var="trans" items="${transList}" >
							...
							<tr>
								...
								<td><c:out value="${trans.donorProfileId.user.loginId}" escapeXml='true'/></td>
