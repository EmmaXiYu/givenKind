...
<title>None Profit Profile</title>
...
<body>
	...
	<div id="mainContainer" class="container">
		<div class='row'>
			<div class='col-sm-12'>
				<h1>None Profit Profile</h1>

				<table class='table'>
					<thead>
						<tr>
							<th class='col-sm-2'>Organization Name</th>
							<th class='col-sm-1'>Mission Statement</th>
							<th class='col-sm-2'>Website</th>
							<th class='col-sm-2'>Address</th>
							<th class='col-sm-2'>city</th>
							<th class='col-sm-2'>EIN</th>
							<th class='col-sm-2'>Approval Status</th>
							<th class='col-sm-2'>Contact Person</th>
							<th class='col-sm-2'>Contact Email</th>
							<th class='col-sm-2'>Contact Phone</th>
							
						</tr>
					</thead>
					<tbody>
									<tr>
										<td><c:out value="${profile.organizationName}" escapeXml='true'/></td>
										<td><c:out value="${profile.missionStatement}" escapeXml='true'/></td>
										<td><c:out value="${profile.website}" escapeXml='true'/></td>
										<td><c:out value="${profile.address1}" escapeXml='true'/></td>
										<td><c:out value="${profile.city}" escapeXml='true'/></td>
										<td><c:out value="${profile.employerIdentificationNumber}" escapeXml='true'/></td>
										<td><c:out value="${profile.approvalStatus}" escapeXml='true'/></td>
