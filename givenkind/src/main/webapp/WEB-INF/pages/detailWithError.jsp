		...
		<div class='row'>
			...
			<c:if test="${empty error}">
				...
				<table>
					...
					<tr>Error: Too many items specified for donation</tr>
					<tr>
						<td>Enter number of items to donate:</td>
						<td>
							<form:form role='form' class='form-horizontal' action='addTransaction' method='post' commandName='activeTransactionItemsDTO'>
								<form:input type='quantity' id='quantity' class='form-control' path='quantity'></form:input>
								<form:errors path='quantity' class='error'></form:errors>
							</form:form>
						</td>
					</tr>
				</table>
				<a href="startTransaction?itemId=${wishlistDTO.id}">
				...
				<table>
					...
					<tr>Error: Too many items requested</tr>
					<tr>
						<td>Enter number of items to request:</td>
						<td>
							<form:form role='form' class='form-horizontal' action='addTransaction' method='post' commandName='activeTransactionItemsDTO'>
								<form:input type='quantity' id='quantity' class='form-control' path='quantity'></form:input>
								<form:errors path='quantity' class='error'></form:errors>
