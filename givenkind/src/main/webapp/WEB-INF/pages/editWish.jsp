	...
	<div id="mainContainer" class="container">
		<div class='row'>
			<div class='col-sm-12'>
				...
				<a href='<c:url value="/wishlist"/>' role='button' class='button'>Return to Wish List</a>
			   <form:form role="form" modelAttribute='wishlistDTO' name="editWish" action="${editUrl}" method='POST' id="editWish">
				<table class='table'>
					...
					<c:url var="editUrl" value="/editWish?wishId=${wishlistDTO.id}"/>
						...
						<tbody>
							<tr>
								...
								<td><form:input id='note' type='textarea'
										class='form-control' path='note' value="${wishlistDTO.note}" maxlength='100'></form:input></td>	
						    	 <td>
						    	 ...
						    	 <form:select id='impact' style="width:250px;"
										...
										<form:errors path="impact" class="error" /></td> 
